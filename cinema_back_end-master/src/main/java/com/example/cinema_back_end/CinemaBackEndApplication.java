...
//
        for (int i = 1; i <= 16; i++) {
            Seat seat = new Seat();
            seat.setName("A" + i);  // Đặt tên ghế lần lượt A1, A2, ...
            seat.setActive(true);   // Đặt trạng thái ghế là active
       ...
       if (movies.isEmpty()) {
           ...
           Movie nhocTrum = addNewMovie("Nhóc Trùm: Nối Nghiệp Gia Đình","https://www.cgv.vn/media/catalog/product/cache/1/small_image/240x388/dd828b13b1cb77667d034d5f59a82eb6/p/o/poster_boss_baby_2_24.12.2021_1_1_1__1.jpg",
                   ...
                   "https://koicine.com/wp-content/uploads/2021/01/126868532_3783205098370168_6896813634057614984_o.jpg",
                   "Tom McGrath","Amy Sedaris, Jeff Goldblum, James Marsden",
                   "Hoạt Hình",LocalDate.parse("18/10/2024",formatter),
           ...
           Movie venom = addNewMovie("Venom: Đối Mặt Tử Thù","https://www.cgv.vn/media/catalog/product/cache/1/small_image/240x388/dd828b13b1cb77667d034d5f59a82eb6/p/o/poster_venom_121121_1__1.jpg",
                   ...
                   "Siêu bom tấn #VENOM: LET THERE BE CARNAGE hứa hẹn trận chiến khốc liệt nhất giữa Venom và kẻ thù truyền kiếp, Carnage.",
                   "https://img.tvzinghd.co/uploads/2021/10/maxresdefault-28984_poster.jpg",
                   "Andy Serkis","Tom Hardy, Michelle Williams, Woody Harrelson, Naomie Harris",
                   "Hành Động, Khoa Học Viễn Tưởng, Phiêu Lưu, Thần thoại",
                   LocalDate.parse("18/10/2024",formatter),97,"https://www.youtube.com/embed/EVWdzVtSh1I",
           ...
           Movie maTran = addNewMovie("Ma Trận: Hồi Sinh","https://www.cgv.vn/media/catalog/product/cache/1/small_image/240x388/dd828b13b1cb77667d034d5f59a82eb6/p/o/poster_matrix_4_1__1.jpg",
                   ...
                   "https://cdn.24h.com.vn/upload/4-2021/images/2021-12-07/publicpreview-1638863983-967-width692height1024.jpg",
                   ...
                   "Hành Động, Khoa Học Viễn Tưởng",LocalDate.parse("24/12/2024",formatter),
           ...
           Movie doremon = addNewMovie("Doraemon: Ôi Bạn Ơi 2","https://www.cgv.vn/media/catalog/product/cache/1/small_image/240x388/dd828b13b1cb77667d034d5f59a82eb6/p/o/poster_doremon_2_1__1.jpg",
                   ...
                   "https://image.tmdb.org/t/p/original/kjQ53CPnOexAwsuFZJNRbxNJkUU.jpg","Ryuichi Yagi, Takashi Yamazaki",
                   "Wasabi Mizuta, Megumi Oohara, Yumi Kakazu, Subaru Kimura, Tomokazu Seki",
                   "Hài, Hoạt Hình",LocalDate.parse("17/12/2024",formatter),
           ...
           Movie cauChuyenPhiaTay = addNewMovie("Câu Chuyện Phía Tây","https://www.cgv.vn/media/catalog/product/cache/1/small_image/240x388/dd828b13b1cb77667d034d5f59a82eb6/p/o/poster_wss_1200x1800__1.jpg",
                   ...
                   "https://www.ixpap.com/images/2024/03/West-Side-Story-Wallpaper-14.jpg",
                   ...
                   "Nhạc kịch, Tình cảm",LocalDate.parse("24/12/2024",formatter),
           ...
           Movie blackPink = addNewMovie("BlackPink The Movie","https://www.cgv.vn/media/catalog/product/cache/1/small_image/240x388/dd828b13b1cb77667d034d5f59a82eb6/p/o/poster_blackpink_vie_2_1__1.jpg",
                   ...
                   "https://cd1.taquilla.com/data/images/t/24/blackpink-the-movie.jpg",
                   "Su Yee Jung, Oh Yoon-Dong","JISOO, JENNIE, ROSÉ, LISA",
                   "Phim tài liệu",LocalDate.parse("24/12/2024",formatter),99,
           ...
           Movie nguoiNhen = addNewMovie("Người Nhện: Không Còn Nhà","https://www.cgv.vn/media/catalog/product/cache/1/small_image/240x388/dd828b13b1cb77667d034d5f59a82eb6/s/n/snwh_poster_bluemontage_4x5fb_1__1.jpg"
                   ...
                   ,"https://fr.web.img2.acsta.net/newsv7/22/02/01/16/58/51251950.jpg",
                   "Jon Watts","Tom Holland, Zendaya, Benedict Cumberbatch, Jacob Batalon, Jon Favreau","Hành Động, Phiêu Lưu",
                   LocalDate.parse("17/12/2024",formatter),
           ...
           if(listBranch.isEmpty()){
               ...
               schedule1.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule5.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule6.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule7.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule8.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule9.setStartDate(LocalDate.parse("2024-10-06"));
               ...
               schedule10.setStartDate(LocalDate.parse("2024-10-06"));
               ...
               schedule.setRoom(r1);
               schedule.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule2.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule77.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule3.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule88.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule11.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               branch3.setName("CINEMA Ba Đình");
               ...
               schedule12.setStartDate(LocalDate.parse("2024-10-05"));
               ...
               schedule13.setStartDate(LocalDate.parse("2024-10-05"));
               schedule13.setStartTime(LocalTime.parse("22:15"));
               schedule13.setPrice(70000);
               scheduleRepository.save(schedule12);

               Branch branch4 = new Branch();
               branch4.setName("CINEMA Phạm Hùng");
               ...
               schedule14.setStartDate(LocalDate.parse("2024-10-05"));
